---
title: "Minnesota Scratch Off Games"
output: 
  html_document:
    theme: yeti
---
...
source("/Users/jennaryan/Documents/R Projects/best-scratch-offs/mn_data_prep.R")
...
MN_logo <- ggplot2::map_data("state","minnesota") %>% 
  ...
  annotate("text",
           x = -94.2,
           y = 47.3,
           label = "Best-Scratch-Offs.com/mn",
           size = 5,
           fontface = "bold")+
  annotate("rect",
           xmin = -95.1,
...
[All Minnesota Games Data](https://best-scratch-offs.com/mn_games_data)
