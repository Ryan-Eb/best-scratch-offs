...
x1 = -93.9
y1 = 29.6
LA_logo <- ggplot2::map_data("state","louisiana") %>% 
  ggplot(aes(long,lat))+
  ...
  annotate("rect",
    ...
    annotate("text",
             x = x1+1.3,
             y = y1+2.9,
             label = "best-scratch-offs.com/la",
             size = 5,
             fontface = "bold")+
 coord_quickmap()+
  theme_bw()+
...
#### Scratch-Off Tickets are sold Everyday in Louisiana
...
Our experts have analyzed all the scratch off games in Louisiana and using advanced data analytics will help you play the games with the best chance of winning.
:::
...
Going for the big one? We keep track of all prizes \$200,000 or greater yet to be claimed.
...
::: {style="text-align: center"}
Top Remaining Prizes greater than \$200K
:::
