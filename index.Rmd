...
---
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JNM7KF5NN7"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JNM7KF5NN7');
</script>
...
We currently have data on the states highlighted in orange on the map below and our regularly adding more states
...
|                                                      |                                                        |                                                         |
|-----------------------|------------------------|-------------------------|
| [California](https://best-scratch-offs.com/ca.html)  | [Illinois](https://best-scratch-offs.com/il.html)      | [North Carolina](https://best-scratch-offs.com/nc.html) |
...
| [Florida](https://best-scratch-offs.com/fl.html)     | [New York](https://best-scratch-offs.com/ny.html)      |                                                         |
|                                                      |                                                        |                                                         |
